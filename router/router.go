...
func SetupRouter(
	...
	ag.POST("/volunteers/create/save", volunteersHandler.VolunteersCreatePostHandler)
	ag.GET("/volunteers/:volunteer_id", volunteersHandler.VolunteersUpdateViewHandler)
	ag.POST("/volunteers/:volunteer_id/save", volunteersHandler.VolunteersUpdatePutHandler)
	...
	ag.POST("/toys/create/save", toysHandler.CreateToyPostHandler)
	ag.GET("/toys/:toy_id", toysHandler.UpdateToyFormHandler)
	ag.POST("/toys/:toy_id/save", toysHandler.UpdateToyPutHandler)
